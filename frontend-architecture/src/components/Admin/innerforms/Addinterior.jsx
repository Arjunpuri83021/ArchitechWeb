...
import { Grid, TextField, Button, Typography, Box, FormControl, Select, MenuItem } from '@mui/material';
import { useDropzone } from 'react-dropzone'; // Import react-dropzone
import Addinteriorpagedata from './adminnavbar/Addinteriorpagedata'; // Import your interior data component
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error('Failed to add interior project.');
      }
      ...
      toast.error('Error occurred while adding the interior project.');
    }
  };
